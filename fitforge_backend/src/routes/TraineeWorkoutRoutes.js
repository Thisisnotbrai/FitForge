...
router.post(
  "/trainee/workouts",
  authenticateToken,
  TraineeWorkoutController.createWorkout
);
...
router.get(
  "/trainee/my-workouts",
  authenticateToken,
  TraineeWorkoutController.getMyWorkouts
);
...
router.get(
  "/trainee/workouts/:id",
  authenticateToken,
  TraineeWorkoutController.getWorkoutById
);
...
router.put(
  "/trainee/workouts/:id",
  authenticateToken,
  TraineeWorkoutController.updateWorkout
);
...
router.delete(
  "/trainee/workouts/:id",
  authenticateToken,
  TraineeWorkoutController.deleteWorkout
);

// Get public workouts from all trainees
router.get(
  "/trainee/public-workouts",
