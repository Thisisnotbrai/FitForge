...
const trainerData = {
  id: 1,
  name: "Alex Johnson",
  avatar: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80",
  ...
  specialties: ["Strength Training", "Weight Loss", "Nutrition Planning", "HIIT", "Functional Training", "Sports Conditioning"],
  upcomingSessions: [
    {
      id: 1,
          ...
          <div className="trainer-sections">
            <div className="trainer-section">
              ...
              {trainer.upcomingSessions.length > 0 ? (
                trainer.upcomingSessions.map((session) => {
                  ...
                  return (
                    <div key={session.id} className="upcoming-session">
                      <div>
                        <div className="session-time">{day} at {time}</div>
                        <div className="session-detail">{session.type} ({session.duration} min)</div>
                      </div>
                ...
                <p>No upcoming sessions scheduled. Contact your trainer to set up your next workout.</p>
              )}
              ...
              <div className="trainer-section">
                ...
                <div className="upcoming-session">
                  <div>
                    ...
                    <div className="session-detail">30 min • Beginner-Friendly</div>
                  </div>
                  <button className="session-action">Start</button>
                </div>
              </div>
